# Generated by Django 4.2.2 on 2023-08-07 02:01
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('2_waiting_for_paymont', 'waiting_for_paymont'), ('3_paid', 'paid'), ('1_cart', 'cart')], default='1_cart', max_length=32)),
        ...
        migrations.AddField(
            model_name='order',
            name='payment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='shop.payments'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
